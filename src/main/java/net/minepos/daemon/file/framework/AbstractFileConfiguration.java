package net.minepos.daemon.file.framework;

import net.minepos.daemon.file.implementations.BlankFileConfiguration;
...
public abstract class AbstractFileConfiguration implements FileConfiguration {
    ...
    protected AbstractFileConfiguration(String extension) {
